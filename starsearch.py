...
Graph_nodes = {
    'Arad' : [('Zerind',75),('Timisoara',118),('Sibia',140)],
    'Zerind' : [('Arad',75),('Oradea',71)],
    'Oradea' : [('Zerind',71),('Sibia',151)],
    'Timisoara' : [('Arad',118),('Lugoj',111)],
    'Lugoj' : [('Timisoara',111),('Mehadia',70)],
    'Mehadia' : [('Lugoj',70),('Drobeta',75)],
    'Drobeta' : [('Mehadia',75),('Criova',120)],
    'Criova' : [('Drobeta',120),('Rim',146),('Pitesti',138)],
    'Rim' : [('Criova',146),('Pitesti',97),('Sibia',80)],
    'Sibia' : [('Arad',140),('Oradea',151),('Fragaras',99),('Rim',80)],
    'Fagaras' : [('Sibia',99),('Becharest',211)],
